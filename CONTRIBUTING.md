...
4. **Make great commits**. A well structured git log is key to a project's maintainability; it efficiently provides insight into when and _why_ things were done for future maintainers of the project.
...
For more information, see _[PEP 483](https://www.python.org/dev/peps/pep-0483/) - The Theory of Type Hints_ and Python's documentation for the [`typing`](https://docs.python.org/3/library/typing.html) module.
